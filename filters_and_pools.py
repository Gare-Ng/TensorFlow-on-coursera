...
weight  = 1
#create a convolution,leaving a 1 pixel margin
...
# Plot the image. Note the size of the axes -- they are 512 by 512,because we leaving 1 pixel margin
plt.gray()
plt.grid(False)
plt.imshow(i_transformed)
#plt.axis('off')#²»ÏÔÊ¾×ø±ê³ß´ç
plt.show()   
#(2, 2) pooling
new_x = int(size_x/2)
new_y = int(size_y/2)
